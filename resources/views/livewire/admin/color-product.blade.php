            ...
            <table>
                ...
                <tbody>
                    @foreach ($product_colors as $product_color)
                        <tr wire:key="product_colot-{{ $product_color->pivot->id }}"> {{-- Nomas pa q no se ondie el livewire --}}
                            ...
                            <td class="px-4 py-2 flex">
                                ...
                                <x-secondary-button class="ml-auto mr-2" {{-- Enviamos la informacion del ID
                                ...
                                <x-danger-button
                                    ...
                                    wire:click="$dispatch('deletePivot',{{$product_color->pivot->id}})"
                                >
                                    Eliminar
                                </x-danger-button>
                            </td>
    ...
    <x-dialog-modal wire:model.live="open">
        ...
        <x-slot name="content">
            <div class="mb-4">
                ...
                <select class="w-full" {{-- Sincronizar con las variables pivot --}} wire:model.live="pivot_color_id">
